 ...
 * actions: traverse the array, locate strings, make copies
...
/*
 * purpose: free the list returned by splitlnie
 * returns: nothing
 * actions: free all strings in list and then free the list
*/
{
    char** cp = list;
    while(*cp)
